...
c=2.99792458e8;
figure(1)
contour(hq.dist_fn.x_px.hydrogen.grid.x/1e-6,hq.dist_fn.x_px.hydrogen.grid.y/(m0*c),(hq.dist_fn.x_px.hydrogen.data)',10,'LineWidth',1,'Fill','on');
xlabel('x (\mum)');
ylabel('p_x (m_ec)');
set(gca,'ydir','normal');
colormap(jet);
