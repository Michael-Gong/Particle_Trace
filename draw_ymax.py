...
#plt.contourf(x, y, ex.T, levels=levels, cmap=cm.gnuplot2)
plt.pcolormesh(x,y,ex.T,cmap=cm.gnuplot2)
...
fig.savefig('./txt/ymax_b_a.png',format='png',dpi=1280)
plt.close("all")
